...
<div 
    className='w-full h-[500px] object-cover absolute inset-0 bg-center bg-cover duration-500'
    style={{
...
<Navbar />
<h1 className='text-[50px] font-bold text-center pt-[120px] font-serif'>CONTACT US</h1>
</div>
     <h1 className="text-[30px] font-bold mb-4 mt-[200px] text-center">If You Have Any Query, Feel<br></br> Free To Contact Us</h1>
